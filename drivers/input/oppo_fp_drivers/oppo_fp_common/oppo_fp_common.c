 ...
 **  Mingzhi.guo    2019/05/10     add for goodix optical fp for 19651 19655 19755
...
#elif CONFIG_OPPO_FINGERPRINT_PROJCT == 19651 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19655 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19755 
fp_module_config_t fp_module_config_list[] = {
    {{1, 1, 1}, FP_GOODIX_OPTICAL_95, CHIP_GOODIX, ENGINEER_MENU_GOODIX_OPTICAL},
};
...
//only for 19601 19605 19609
#elif CONFIG_OPPO_FINGERPRINT_PROJCT == 18041 || CONFIG_OPPO_FINGERPRINT_PROJCT == 18539 
fp_module_config_t fp_module_config_list[] = {
    {{1, 1, 1}, FP_GOODIX_OPTICAL_95, CHIP_GOODIX, ENGINEER_MENU_GOODIX_OPTICAL},
};
#else
...
#if CONFIG_OPPO_FINGERPRINT_PROJCT == 19651 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19655 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19755
