...
sub_mainboard_set:
        ...
        case OPPO_18041:
               ...
               if ((sub_id1 == 1) && (sub_id2 == 1) && ((operator == OPERATOR_FOREIGN) || (operator == OPERATOR_RM_FOREIGN_VIETNAM_128GB))) {
                   snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
        ...
        case OPPO_18383:
                ...
                if ((sub_mainboard_volt > 500 && sub_mainboard_volt < 650) &&
                  (pcbVersion == HW_VERSION__10 || pcbVersion == HW_VERSION__11)) {
                        ...
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
                } else if ((sub_mainboard_volt > 0 && sub_mainboard_volt < 200) && (pcbVersion == HW_VERSION__13)) {
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
                } else if ((sub_mainboard_volt > 850 && sub_mainboard_volt < 1000) && (pcbVersion == HW_VERSION__14)) {
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
                } else if ((sub_mainboard_volt > 1100 && sub_mainboard_volt < 1250) && (pcbVersion > HW_VERSION__14)) {
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
                } else {
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-unmatch");
                }
                break;
        case OPPO_19651:
               pr_err("19651 sub_hw_id1:%d sub_hw_id2:%d\n", sub_id1, sub_id2);
			   
               if ((operator == OPERATOR_RM_FOREIGN_INDIA) || (operator == OPERATOR_FOREIGN) || (operator == OPERATOR_FOREIGN_EUROPE) ||
			   (operator == OPERATOR_RM_FOREIGN_VIETNAM_128GB) || (operator == OPERATOR_RM_FOREIGN_NFC) || (operator == OPERATOR_ALL_CHINA_CARRIER)){
                   snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
               } else {
                   snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-unmatch");
               }
