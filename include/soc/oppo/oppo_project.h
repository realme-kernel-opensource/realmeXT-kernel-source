...
/*TongJing.Shi@EXP.DataComm.Phone, 2014.04.18, Add for exp just 3G no 4G*/
		...
		OPERATOR_RM_FOREIGN_INDIA = 31,//linzhenming add for INDIA
		OPERATOR_RM_FOREIGN_VIETNAM_128GB = 32,//linzhenming add for VIETNAM_128GB
		OPERATOR_RM_FOREIGN_NFC = 34,//linzhenming add for foreign nfc
};
